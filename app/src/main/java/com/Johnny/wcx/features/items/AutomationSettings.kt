...
// NB: 共享模型（AutomationToggleRule / AutomationTimeRangeRule / AutomationKeywordMode /
// AutomationKeywordRule / AtomicJsonConfigStore / AutomationContactSettingsSelector /
// formatAutomationMinute / automationKeywordSummary）已统一归 AutomationCore.kt 所有，
// 本文件只保留未被迁移的旧版 UI 组合件，切勿在此重复声明模型类。
